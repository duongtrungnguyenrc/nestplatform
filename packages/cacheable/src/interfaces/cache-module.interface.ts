...
export type CacheOptions<StoreConfig extends PlainObject = PlainObject> = CacheManagerOptions & StoreConfig;

export type CacheModuleOptions<StoreConfig extends PlainObject = PlainObject> = CacheOptions<StoreConfig>;
 ...
 * @publicApi
 */
export interface CacheOptionsFactory<StoreConfig extends PlainObject = PlainObject> {
 ...
 * @publicApi
 */
export type CacheModuleAsyncOptions<StoreConfig extends PlainObject = PlainObject> = ConfigurableModuleAsyncOptions<
