...
- **TTL Support**: Configure time-to-live for each lock to prevent deadlocks.
- **Logging**: Built-in lifecycle logging for lock acquisition and release.
- **Multiple Providers**: Register multiple lock providers and select per-method.
...
- Adjusted injection decorator typing for TypeScript 6 with older NestJS versions.
